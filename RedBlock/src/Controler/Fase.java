    ...
    public int getIdDoMapaLidoDoJson() {
     ...
     private void carregarFaseDeJson(String nomeArquivoJson) {
        ...
        try {
            ...
            if (this.ball == null) {
                System.err.println("AVISO CRÍTICO: Nenhum PISO_SPAWN encontrado no JSON: " + nomeArquivoJson + ". Adicionando Ball em (0,0).");
                mapaDePisos[0][0] = new Piso(TiposPiso.PISAVEL_SIMPLES);
                this.ball = new Ball("bola.png");
                this.ball.setPosicao(0, 0);
                this.addPersonagem(this.ball);
            }
